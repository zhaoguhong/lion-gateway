...
/**
 * Less than or equal predicate - numeric comparison, check if request value is <= target
 *
 * @author zhaoguhong
 * @date 2026/05/01
 */
@Component
public class LessThanOrEqualPredicate implements Predicate {
  ...
  public String operator() {
    return PredicateEnum.LE.getOperator();
  }
